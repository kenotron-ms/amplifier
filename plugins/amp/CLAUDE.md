# Amplifier Plugin - Claude Code Guidance

This file provides guidance to Claude Code when using the Amplifier plugin.

## Import Complete Guidance

Import this single comprehensive file for all Amplifier plugin guidance:

**@AMP_GUIDANCE.md** - Complete AI assistant guidance (combines philosophy, patterns, agents)
...
- @philosophies/IMPLEMENTATION_PHILOSOPHY.md - Deep dive on ruthless simplicity
- @philosophies/MODULAR_DESIGN_PHILOSOPHY.md - Detailed modular design ("bricks & studs")
- @philosophies/DESIGN-PHILOSOPHY.md - Design system philosophy
- @philosophies/DESIGN-PRINCIPLES.md - Actionable design guidance
- @philosophies/DESIGN-FRAMEWORK.md - Design sensibility framework
- @philosophies/DESIGN-VISION.md - Design vision and values

## Plugin Resources

- **23 specialized agents** in `agents/` (core, design, knowledge)
- **12 commands** in `commands/` (commit, ddd workflow, reviews, etc.)
- **18 tools** in `tools/` (transcript builders, worktree managers, collectors)
- **5 example CLI tools** in `scenarios/` (blog_writer is THE exemplar)
